	 ...
	 public void withdrawlAmount() 
		...
		
		{
			...
			public void changelocation() {
				System.out.println("enter accountnumber to change location ");
				int accountnumber=sc.nextInt();
				
				
				String location= ((Scanner) scStr).nextLine();
				boolean foundlocation=false;
				for( int i = 0;i<nooOfAccountEntry;i++) {
					Account a = allAccounts[i];
					foundlocation=true;{
						System.out.println("the new updated location is:"+location);
					}
				}
			}
			}